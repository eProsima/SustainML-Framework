...
#ifndef _EPROSIMA_SUSTAINML_MODEL_TREE_TREEMODEL_H
#define _EPROSIMA_SUSTAINML_MODEL_TREE_TREEMODEL_H
...
#include <sustainml/nlohmann-json/json.hpp>
...
public:
    ...
    Q_INVOKABLE void updateFromJsonString(const QString& json_str);
