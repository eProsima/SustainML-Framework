        ...
        const QJsonObject& json_obj)
{
    ...
    emit reiterate_user_inputs(
        ...
        inputs_str,
        outputs_str,
        extraData.value("dataset_metadata_description").toString(),
        extraData.value("dataset_metadata_topic").toString(),
        extraData.value("dataset_metadata_profile").toString(),
        extraData.value("dataset_metadata_keywords").toString(),
        extraData.value("dataset_metadata_applications").toString(),
        ...
        const QJsonObject& json_obj)
{
    ...
    {
        for (const QJsonValue& value : json_obj["tasks"].toArray())
        {
